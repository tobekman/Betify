...
class OneXTwo {
  ...
  factory OneXTwo.fromJson(String source) =>
      OneXTwo.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'OneXTwo(date: $date, stake: $stake, odds: $odds, result: $result, betType: $betType, homeTeam: $homeTeam, awayTeam: $awayTeam, oneXTwoPrediction: $oneXTwoPrediction, homeTeamScore: $homeTeamScore, awayTeamScore: $awayTeamScore)';
  }
